...
\begin{center}
\input{./stacked_wh_that_post_oo.io.mgproc.forest}
\end{center}

\newpage
2) stacked that post os
\begin{center}
\input{./stacked_wh_that_post_os.io.mgproc.forest}
\end{center}

\newpage
3) stacked wh that post so
\begin{center}
\input{./stacked_wh_that_post_so.io.mgproc.forest}
\end{center}

\newpage
4) stacked wh that post ss
\begin{center}
\input{./stacked_wh_that_post_ss.io.mgproc.forest}
\end{center}
