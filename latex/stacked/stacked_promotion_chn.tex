...
\begin{center}
\input{./stacked_prom_pre_oo.io.mgproc.forest}
\end{center}

\newpage
2) stacked prom pre os
\begin{center}
\input{./stacked_prom_pre_os.io.mgproc.forest}
\end{center}

\newpage
3) stacked prom pre so
\begin{center}
\input{./stacked_prom_pre_so.io.mgproc.forest}
\end{center}

\newpage
4) stacked prom pre ss
\begin{center}
\input{./stacked_prom_pre_ss.io.mgproc.forest}
\end{center}
