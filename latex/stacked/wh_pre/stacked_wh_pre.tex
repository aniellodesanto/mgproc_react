...
\begin{center}
\input{./stacked_wh_pre_oo.io.mgproc.forest}
\end{center}

\newpage
2) stacked wh pre os
\begin{center}
\input{./stacked_wh_pre_os.io.mgproc.fores}
\end{center}

\newpage
3) stacked wh pre so
\begin{center}
\input{./stacked_wh_pre_so.io.mgproc.forest}
\end{center}

\newpage
4) stacked wh pre ss
\begin{center}
\input{./stacked_wh_pre_ss.io.mgproc.forest}
\end{center}
