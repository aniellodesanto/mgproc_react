...
\begin{center}
\input{./stacked_prom_post_oo.io.mgproc.forest}
\end{center}

\newpage
2) stacked prom post os
\begin{center}
\input{./stacked_prom_post_os.io.mgproc.forest}
\end{center}

\newpage
3) stacked prom post so
\begin{center}
\input{./stacked_prom_post_so.io.mgproc.forest}
\end{center}

\newpage
4) stacked prom post ss
\begin{center}
\input{./stacked_prom_post_ss.io.mgproc.forest}
\end{center}
